...
/**
 * Manages an overlay display window, used for on-top local video playback
 * Need to update this to show information for non-video playback (radio track info e.g.)
 */
public abstract class OverlayDisplayWindow {
    ...
    /**
     * Implementation for PonyvilleAPI version 17+.
     */
